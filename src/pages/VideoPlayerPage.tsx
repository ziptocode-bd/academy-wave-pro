...
export default function VideoPlayerPage() {
  ...
  return (
    <div
      className={`animate-fade-in flex flex-col overflow-hidden lg:flex-row lg:gap-4 lg:p-4 ${
        isMobile
    ...
    >
      <div className="lg:flex-1 flex flex-col min-h-0 h-full">
        <div className="relative z-0 bg-background shrink-0">
          <div
            ref={containerRef}
          ...
          <div className="px-3 py-2.5 sm:p-4 shrink-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <h2 className="font-semibold text-foreground text-base sm:text-lg">{video!.title}</h2>
            </div>
            ...
            <div className="flex items-center gap-2 mt-3 flex-wrap">
              ...
              {video!.pdfURL && (
                <a
                  ...
                  className="flex items-center gap-1 px-3 py-1.5 text-sm rounded-md bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity"
                >
              ...
              {!isMobile && (
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-1.5 text-sm rounded-md bg-accent border border-border text-foreground hover:bg-accent/80 transition-colors"
                >
        ...
        {/* Side panel (mobile) */}
        <div className={`flex-1 min-h-0 overflow-hidden lg:hidden flex flex-col px-2 pb-2 sm:px-3 sm:pb-3 ${video!.isLive ? "" : "pt-0"}`}>
          {video!.isLive ? (
            <LiveChat videoId={video!.id} courseId={video!.courseId} isLive={video!.isLive} />
          ) : (
            <>
              <SidePanelHeader
      ...
      {/* Side panel (desktop) */}
      <div className="hidden lg:flex lg:w-96 flex-col h-full min-h-0 shrink-0">
        {video!.isLive ? (
          <LiveChat videoId={video!.id} courseId={video!.courseId} isLive={video!.isLive} />
        ) : (
          <>
