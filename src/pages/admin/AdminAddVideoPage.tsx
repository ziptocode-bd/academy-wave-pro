...
import { Film, CheckCircle, ArrowLeft, Radio } from "lucide-react";
      ...
      <form onSubmit={handleSubmit} className="px-3 sm:px-4 pt-4 space-y-4">
        <div className="rounded-xl border border-border bg-card/50 overflow-hidden">
          ...
          <div className="p-4 space-y-3">
            ...
            {/* Live Class Toggle */}
            <div className="p-3 rounded-xl border border-red-500/30 bg-red-500/5 flex items-center justify-between gap-3">
              <div className="flex items-center gap-2.5 min-w-0">
                <div className={`p-2 rounded-lg ${isLive ? "bg-red-500 text-white" : "bg-muted text-muted-foreground"}`}>
                  <Radio className={`h-4 w-4 ${isLive ? "animate-pulse" : ""}`} />
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-semibold text-foreground">Live Class (লাইভ ক্লাস)</span>
                    {isLive && (
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    অন থাকলে এটি লাইভ ক্লাস হিসেবে লাইভ চ্যাটসহ দেখানো হবে
                  </p>
                </div>
              </div>
